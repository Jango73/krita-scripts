...
def detect_face_and_select():
    ...
    largest = max(blobs, key=blob_score)
    ...
    print(f"✅ Visage détecté à ({sel_x}, {sel_y}) → sélection {SELECTION_WIDTH}x{SELECTION_HEIGHT}")

detect_face_and_select()
